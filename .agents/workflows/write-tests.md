---
description: Write unit and integration tests for a feature module
---
...
- ✅ 401 — no token → unauthorized (if security applicable)
...
- Test full HTTP cycle: request → controller → service → repository → response
...
Only test utils that have actual logic.
