...
public class OpenAPIConfig {
	...
	//     // @formatter:off
	// 	return new Contact()
	// 			.email("dkl@excample.com")
	// 			.name("Naam")
	// 			.url("https://testAGLibraryManager.com");
	// 	// @formatter:on
	// }
	...
	//     // @formatter:off
	// 	return new Info()
	// 			.title("AGLibraryManager API")
	// 			.version("1.0")
	// 			.contact(createContact())
	// 			.description("This API exposes all endpoints (testAGLibraryManager)")
	// 			.termsOfService("https://testAGLibraryManager.com")
