...
- **Lõi Thực Thể (Entity):** `src/main/java/com/example/testaglibrarymanager/model/entity/Book.java`
- **Bộ Xử Lý (Service):** `src/main/java/com/example/testaglibrarymanager/service/book/BookServiceImpl.java`
- **Bộ Phát Sóng (Controller):** `src/main/java/com/example/testaglibrarymanager/controller/BookController.java`
