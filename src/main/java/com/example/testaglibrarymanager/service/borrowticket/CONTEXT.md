...
- **Lõi Thực Thể (Entity):** `src/main/java/com/example/testaglibrarymanager/model/entity/BorrowTicket.java`
- **Bộ Xử Lý (Service):** `src/main/java/com/example/testaglibrarymanager/service/borrowticket/BorrowTicketServiceImpl.java`
- **Bộ Phát Sóng (Controller):** `src/main/java/com/example/testaglibrarymanager/controller/BorrowTicketController.java`
